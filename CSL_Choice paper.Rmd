...
```{r plotParams, echo=FALSE}
baseline = 200
plotWidth = 24
plotHeight = 9
```

```{r makeLearnPlots, echo=FALSE}
#Subtracted
allData %>%
...
Stats results (`r papaja::apa_print.afex_aov(learn.NtShape.aov)$full_result`) and then also 
(`r papaja::apa_print.afex_aov(learn.NtCol.aov)$full_result`) and then also 
(`r papaja::apa_print.afex_aov(learn.PdShape.aov)$full_result`) and then also 
(`r papaja::apa_print.afex_aov(learn.PdCol.aov)$full_result`) and then also 
...
`r papaja::apa_print.afex_aov(search.NtTO.aov)$full_result`
`r papaja::apa_print.afex_aov(search.NtTD.aov)$full_result`
`r papaja::apa_print.afex_aov(search.NtDT.aov)$full_result`
`r papaja::apa_print.afex_aov(search.PdTO.aov)$full_result`
`r papaja::apa_print.afex_aov(search.PdTD.aov)$full_result`
`r papaja::apa_print.afex_aov(search.PdDT.aov)$full_result`
