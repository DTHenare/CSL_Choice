...
choicePercent <- behavData %>%
  ...
  geom_smooth(se = FALSE, alpha = 0.3, size=1) +
  scale_colour_manual(values=c("green4", "gray42")) +
  labs(y = "Chose search (%)") +
  lims(y=c(0,100)) +
