...
rm( groupInfo,intEffectTTest, acc, acc.res, acc.stat, autoCor, Cor, distCost, rt, rt.res, rt.stat, sData, searchAcc, searchAcc.aov, searchAcc.res, searchRT, searchRT.aov, searchRT.fup, searchRT.res, t.out, sub, subj)
gc()
```
