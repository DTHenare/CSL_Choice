...
choicePercent <- behavData %>%
  ...
  lims(y=c(0,100)) +
  theme(legend.justification = c(18.5,0),
        legend.position = c(18.5,0))
...
final <- grid.arrange(choicePercent,choiceRTPlot, ncol = 2, nrow = 1)
ggsave("taskChoice.jpg", plot = final, dpi = 600, width = 16, height = 12, units = "cm")
```
