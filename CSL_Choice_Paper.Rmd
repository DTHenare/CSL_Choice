...
In the categorisation task, we see now significant difference between the shape group and the colour group for response times (`r catAcc.res$full_result`) and accuracy (`r catRT.res$full_result`).
...
One difference observed between the results of @feldmann2015you and our study is that they observed a negativity to distractors in the search task for participants in the colour group whereas we see no such component. A negativity to distractors, sometimes referred to as an ND, has been observed in a number of search tasks and is typically viewed as reflecting attentional selection of the distractor and therefore analogous to the NT. @feldmann2015you therefore suggested that an ND was elicited in the colour group for colour distractors because selection history biases their attention toward coloured items. Therefore for those in the colour group, the distractor is initially selected for processing before having to be suppressed as a distractor, and this may therefore explain the increased distractor suppression observed for participants in that group.

@feldmann2015you also observed a greater negativity to colour distractors for participants in the colour group, an effect that we do not observe in our
