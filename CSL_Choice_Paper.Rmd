...
Participants were also informed to attempt to keep the task selection balanced at around 50% search and 50% choice trials throughout the experiment. In order to test for this we calculated task choice across the task. This is shown in figure\ \@ref(fig:choseSearch)
