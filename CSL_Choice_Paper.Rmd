...
abstract: |
  A typical visual scene contains vast amounts of information, and only a fraction of this can be fully processed by the human visual system. To understand how our attention is directed to one object over another, research has historically focussed on the interaction between bottom-up stimulus features, and an individual's top-down goals. In this study we evaluate how a third factor, selection history, interacts with top-down control mechanisms during visual search. Participants in our task are assigned to one of two groups in which they develop a history of shape selection or colour selection in one task, while performing visual search in a second task. A voluntary task selection procedure allowed participants the choice of which task they would perform on any given trial thereby maximising their opportunity for top-down preparation. We recorded EEG while participants performed this task and extracted lateralised ERP components as indices of target selection and distractor suppression. Our results show that selection history continues to guide attention during visual search, even when top-down control mechanisms are maximised in a voluntary task selection procedure. 
