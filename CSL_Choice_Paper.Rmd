...
We performed a 2x2x2 mixed ANOVA in order to evaluate the effect of group (shape vs colour) task transition (repeat vs switch), and task (categorisation vs search) on response times. 
