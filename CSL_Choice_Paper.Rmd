...
ggsave("Figures/CNVERPs_Average.jpg", dpi = 300, width = 5, height = 5.3, units = c("in"))
```

Comparing the preparatory activity in our experiment to the preparatory activity recorded by @kadel2017selection, we see a significantly larger CNV at frono-central electrodes in our voluntary task switching procedure (`r front.stats$full_result`). We also see a significantly larger positivity at posterior electrods in the cued task switching procedure used by @kadel2017selection (`r post.stats$full_result`).
