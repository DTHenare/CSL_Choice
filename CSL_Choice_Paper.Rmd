...
(ref:ExpCompPlot) Preparatory activity in the voluntary task selection procedure used in our experiment, compared to the preparatory activity in a cued version of our task carried out by @kadel2017selection. A) ERP activity centred on the stimulus display (either learn or search) onset taken from a cluster of fronto-central electrodes to measure the CNV, and a cluster of posterior electrodes to measure teh posterior positivity. The solid vertical line indicates the onset of the fixation cross preceding the stimulus display on each trial. In the Cued task this fixation indicated which task participants would be presented with, int he voluntary task this fixation started after participants had selected the task they would like to perform. The vertical dotted line shows the onset of the stimulus display and the component window used to measure preparatory activity is highlighted in yellow. B) Scalp distribution of ERP activity within the time window of interest, plotted separately for the two experiments. These display the larger fronto-central negativity typical of voluntary task switching paradigms and indicative of enhanced top-down control.
